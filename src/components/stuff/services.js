            ...
            <div className="row">
                ...
                <div className="ec_ser_content ec_ser_content_2 col-sm-12 col-md-6 col-lg-3 zoomIn" data-animation="zoomIn"
                    ...
                    <div className="ec_ser_inner">
                        ...
                        <div className="ec-service-desc">
                            <h2>24X7 {t("Support")}</h2>
                            <p>{t("Contact us 24 hours a day, 7 days a week")}</p>
                        </div>
                    </div>
                </div>
                <div className="ec_ser_content ec_ser_content_3 col-sm-12 col-md-6 col-lg-3 zoomIn" data-animation="zoomIn"
                    data-animated="true">
                    <div className="ec_ser_inner">
                        <div className="ec-service-image">
                            <svg xmlns="http://www.w3.org/2000/svg" height="511pt" viewBox="0 1 511.99981 511"
                                width="511pt"
                                src="https://loopinfosol.in/themeforest/ekka-html-v3/ekka-html/assets/images/icons/service_3.svg"
                                className="svg_img" alt="">
                                <path
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="512" height="512"
                                ...
                                <g id="_04-security" data-name="04-security">
                                    <g id="linear_color-2" data-name="linear color">
                                        ...
                                        <path
                                            d="M422.247,320.191a10,10,0,0,0-14.056,1.562l-26.272,32.841L365.547,343.68a10,10,0,0,0-11.094,16.64l24,16a10,10,0,0,0,13.356-2.073l32-40A10,10,0,0,0,422.247,320.191Z">
                                        </path>
                                    </g>
                                </g>
                            </svg>
